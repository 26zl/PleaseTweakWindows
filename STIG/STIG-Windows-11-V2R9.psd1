@{
    SchemaVersion = 1
    Id = 'stig-windows-11-v2r9'
    Name = 'Windows 11 STIG V2R9-aligned baseline'
    Benchmark = 'Microsoft Windows 11 STIG SCAP Benchmark V2R9'
    Coverage = 'Curated automatable subset; validation and manual review are still required.'
    Routes = @(
        ...
        @{ ApplyScript = 'System Security/system-security.ps1'; ApplyAction = 'security-lock-screen-camera-disable'; RevertScript = 'System Security/revert-system-security.ps1'; RevertAction = 'security-lock-screen-camera-revert' }
        ...
        @{ ApplyScript = 'System Security/system-security.ps1'; ApplyAction = 'security-powershell-audit'; RevertScript = 'System Security/revert-system-security.ps1'; RevertAction = 'security-powershell-audit-revert' }
        ...
        @{ ApplyScript = 'System Security/system-security.ps1'; ApplyAction = 'security-wsh-disable'; RevertScript = 'System Security/revert-system-security.ps1'; RevertAction = 'security-wsh-disable-revert' }
        ...
        @{ ApplyScript = 'System Security/system-security.ps1'; ApplyAction = 'security-ntfs-8dot3-disable'; RevertScript = 'System Security/revert-system-security.ps1'; RevertAction = 'security-ntfs-8dot3-disable-revert' }
        ...
        @{ ApplyScript = 'Exploit Protection/exploit-protection.ps1'; ApplyAction = 'security-spectre-meltdown-enable'; RevertScript = 'Exploit Protection/revert-exploit-protection.ps1'; RevertAction = 'security-spectre-meltdown-revert' }
        ...
        @{ ApplyScript = 'Device Guard/device-guard.ps1'; ApplyAction = 'security-hvci-enable'; RevertScript = 'Device Guard/revert-device-guard.ps1'; RevertAction = 'security-hvci-enable-revert' }
        @{ ApplyScript = 'Device Guard/device-guard.ps1'; ApplyAction = 'security-credential-guard-enable'; RevertScript = 'Device Guard/revert-device-guard.ps1'; RevertAction = 'security-credential-guard-enable-revert' }
        ...
        @{ ApplyScript = 'Device Guard/device-guard.ps1'; ApplyAction = 'security-kernel-dma-protection'; RevertScript = 'Device Guard/revert-device-guard.ps1'; RevertAction = 'security-kernel-dma-protection-revert' }
        ...
        @{ ApplyScript = 'Network Security/network-security.ps1'; ApplyAction = 'tls-hardening'; RevertScript = 'Network Security/revert-network-security.ps1'; RevertAction = 'tls-hardening-revert' }
        ...
        @{ ApplyScript = 'Network Security/network-security.ps1'; ApplyAction = 'security-smb-modern-enforce'; RevertScript = 'Network Security/revert-network-security.ps1'; RevertAction = 'security-smb-modern-enforce-revert' }
        ...
        @{ ApplyScript = 'Network Security/network-security.ps1'; ApplyAction = 'security-spooler-rpc-disable'; RevertScript = 'Network Security/revert-network-security.ps1'; RevertAction = 'security-spooler-rpc-disable-revert' }
        ...
        @{ ApplyScript = 'Network Security/network-security.ps1'; ApplyAction = 'security-winrm-harden'; RevertScript = 'Network Security/revert-network-security.ps1'; RevertAction = 'security-winrm-harden-revert' }
