...
if ($doRepair) {
    ...
    if (Get-Command Get-FileFromWeb -ErrorAction SilentlyContinue) {
        try {
            ...
            Test-SignedFile -Path "$env:TEMP\EdgeWebView.exe" -PublisherPatterns @('Microsoft Corporation')
    ...
    if (Get-Command Get-FileFromWeb -ErrorAction SilentlyContinue) {
        try {
            ...
            Test-SignedFile -Path "$env:TEMP\GamingRepairTool.exe" -PublisherPatterns @('Microsoft Corporation')
